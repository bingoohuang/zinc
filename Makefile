...
pkg := github.com/prabhatsharma/zinc/pkg/meta/v1

ZINC_LDFLAGS="-w -s -X $PKG.Version=${VERSION} -X $PKG.BuildDate=${BUILD_DATE} -X $PKG.CommitHash=${COMMIT_HASH}"
